...
export * from './aggregate/page/storage-aggregate.component';
export * from './aggregate/embedded/storage-aggregate-embedded.component';
export * from './view/storage-view.component';
export * from './struct/storage-struct.component';
export * from './types/storage-types.component';
